            ...
            <?php if (count($abisuak) > 0): ?>
                <?php foreach ($abisuak as $a): ?>
                    <div class="abisu-txartela <?php echo $a['irakurrita'] ? '' : 'ez-irakurrita'; ?>">
                        ...
                        <span class="abisu-data"><img src="../img/calendar-days.svg" alt="" style="width: 1.2em; height: 1.2em; vertical-align: middle; filter: invert(0.3) sepia(1) saturate(5) hue-rotate(200deg); margin-right: 5px;"> <?php echo date('Y/m/d H:i', strtotime($a['data'])); ?></span>
                    </div>
                <?php endforeach; ?>
            <?php else: ?>
