    ...
    <main class="panel-nagusia">
        ...
        <div class="panel-sareta flex-tartea-20 marjina-behe-30" style="display: grid; grid-template-columns: 1fr 1fr; gap: 30px; margin-bottom: 30px;">
            <div class="kutxa-zuria-itzala testua-erdian">
                <div style="font-size: 3rem; margin-bottom: 10px;"><img src="../img/users.svg" alt="" style="width: 1.2em; height: 1.2em; vertical-align: middle; iragazkia: invert(0.3) sepia(1) saturate(5) hue-rotate(200deg); margin-right: 5px;"></div>
            ...
            <div class="kutxa-zuria-itzala testua-erdian">
                <div style="font-size: 3rem; margin-bottom: 10px;"><img src="../img/calendar-days.svg" alt="" style="width: 1.2em; height: 1.2em; vertical-align: middle; iragazkia: invert(0.3) sepia(1) saturate(5) hue-rotate(200deg); margin-right: 5px;"></div>
        ...
        <section class="menu-sareta">
            <a href="pazienteak.php" class="menu-txartela">
                <div class="txartel-ikonoa"><img src="../img/users.svg" alt="Nire Pazienteak" style="width: 48px; height: 48px; iragazkia: invert(0.3) sepia(1) saturate(5) hue-rotate(200deg);"></div>
