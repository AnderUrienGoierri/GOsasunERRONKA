...
$user_data = $stmtH->fetch(PDO::FETCH_ASSOC);

$page_title = "Harrera Panela - GOsasun";
$current_page = "index";
$custom_css = "index_harrera.css";
...
?>
    ...
    <main class="panel-nagusia">
        <section class="kaixo-atalak flex-zentratua-20" >
            <img src="../<?php echo htmlspecialchars($user_data['irudia'] ?? 'img/lehenetsia_harrera.png'); ?>" alt="Zure profila" class="profil-irudia-80">
            <div>
                <h1 class="izenburu-nagusia">Ongi etorri, <?php echo htmlspecialchars($user_data['izena']); ?>!</h1>
