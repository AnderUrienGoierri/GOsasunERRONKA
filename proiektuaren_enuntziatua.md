...
XML fitxategi honetako informazioa irakurriko da aplikazioaren itxura zehazteko. Horrez gain, web aplikaziotik bertatik konfigurazioko XML hau aldatzeko aukera egongo da (adibidez, ezarpenen panel baten bidez), eta informazio hori XML-an gorde ondoren sisteman modu egokian bistaratuko da. Sistema hau bi mailatan egongo da banatuta: erabiltzaile bakoitzak bere ezarpen propioak gorde ahal izango ditu, eta horrez gain, Harrerako langileek "Zentroaren Konfigurazio Orokorra" ezarri ahal izango dute era globalean. Bietan ere, webgunearen hasierako balore korporatiboetara itzultzeko aukera (berrezarri) egongo da.
